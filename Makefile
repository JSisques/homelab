...
SERVICES := it-tools n8n obsidian jellyfin downloads monitoring homepage uptime-kuma cloudflared adguard-home traefik wireguard pbs promtail k3s-server supabase
